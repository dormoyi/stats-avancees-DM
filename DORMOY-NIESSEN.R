...
plot(lmf$fitted,df$pollution,main="ajust�es/observ�es") # pour voir si la variation est aléatoire (bien répartie sur la droite, et de meme variance)
abline(0,1)
# ici les résidus sont bien répartis de part et d'autre de la droite, la distribution semble normale


plot(lmf$fitted,lmf$residuals,main="diff�rents r�sidus",ylim=c(-3,3))
abline(h=0,lty=2)
...
# 
title(main="Validation du mod�le obtenu par la m�thode descendante", outer=TRUE)
